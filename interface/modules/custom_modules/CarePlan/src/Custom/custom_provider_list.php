...
function doedclick_add() {
    ...
    let scriptTitle = 'custom_provider_edit.php?ppid=0&csrf_token_form=' + <?php echo js_url(CsrfUtils::collectCsrfToken()); ?>;
...
function doedclick_edit(ppid) {
    ...
    let scriptTitle = 'custom_provider_edit.php?ppid=' + ppid + '&csrf_token_form=' + <?php echo js_url(CsrfUtils::collectCsrfToken()); ?>;
...
<body>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title">
                    <h2><?php echo xlt('Procedure/Laboratory Providers');?><?php echo $help_icon; ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method='post' action='custom_provider_list.php'>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                while ($row = sqlFetchArray($res)) {
                                	$type = 'Standard';
                                	if ($row['type'] == 'Q') $type = 'Quest';
                                	if ($row['type'] == 'L') $type = 'Labcorp';
                                	if ($row['type'] == 'G') $type = 'Generic';
