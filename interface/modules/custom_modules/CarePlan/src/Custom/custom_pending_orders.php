...
if (!AclMain::aclCheckCore('patients', 'lab')) {
    echo (new TwigContainer(null, $GLOBALS['kernel']))->getTwig()->render('core/unauthorized.html.twig', ['pageTitle' => xl("Pending Procedure Orders")]);
    exit;
}
...
<h2><?php echo xlt('Pending Procedure Orders')?></h2>

<form method='post' action='custom_pending_orders.php' onsubmit='return top.restoreSession()'>
 ...
 <tr>
  <td>
   <div class="btn-group" role="group">
    <button type='submit' class='btn btn-secondary btn-refresh' value="1" name='form_refresh'><?php echo xlt('Refresh'); ?></button>
    <button type='submit' class='btn btn-secondary btn-transmit' value="1" name='form_csvexport'><?php echo xlt('Export to CSV'); ?></button>
