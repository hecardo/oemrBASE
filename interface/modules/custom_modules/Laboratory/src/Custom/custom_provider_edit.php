...
// List values
$list_prot = new Options('Processor_Protocol');
$list_type = new Options('Processor_Type');
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <form method='post' name='theform' action="custom_provider_edit.php?ppid=<?php echo attr_url($ppid); ?>&csrf_token_form=<?php echo attr_url(CsrfUtils::collectCsrfToken()); ?>">
                    ...
                    <div class="col-12">
                        <div class="clearfix">
                            <div class="row col-12">
                                <div class="col-sm-6">
		                        	<div class="label-div">
				                		<label class="col-form-label" for="form_name"><?php echo xlt('Usage'); ?>:</label><a href="#usage_info" class="info-anchor icon-tooltip" data-toggle="collapse"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
	    	                        </div>
								...
								<div class="col-sm-6">
		                        	<div class="label-div">
				                		<label class="col-form-label" for="form_name"><?php echo xlt('Type'); ?>:</label><a href="#type_info" class="info-anchor icon-tooltip" data-toggle="collapse"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
	    	                        </div>
	                                <select name='form_type' id='form_type' class='form-control' title='<?php echo xla('Custom Laboratory Type'); ?>'>
										<?php $list_type->showOptions($row['type'],'Standard',true); ?>
	                                </select>
			                        <div id="type_info" class="collapse">
			                            ...
			                            <p><?php echo xlt("Type - is only required if you have installed and are using the custom laboratory interface module."); ?></p>
			                            <p><?php echo xlt("This field is only used to control which custom laboratory interface is appropriate for this provider and should be set to 'Standard Provider' for all other interfaces."); ?></p>
			                        </div>
	                            </div>
	                        </div>
                        </div>
                            ...
                            <div class="row col-12">
                                <div class="col-sm-6">
                                    <select name='form_protocol' id='form_protocol' class='form-control'>
                                        <?php $list_prot->showOptions($row['protocol'],'Protocol'); ?>
                                    </select>
                                </div>
                                <div class="col-sm-6">
